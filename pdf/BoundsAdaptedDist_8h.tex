...
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
2018-\/2019 The bounds-\/adapted version of a distribution is a distribution that has been wrapped by an adapter-\/class that modifies the distribution so that the bounds can be set to finite values.
\end{DoxyDate}
