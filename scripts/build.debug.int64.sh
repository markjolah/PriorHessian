#!/bin/bash
# scripts/build.debug.int64.sh <cmake args ...
#
# Debug-only build to local install prefix with build-tree export and OPT_BLAS_INT64=On
#
# Cleans up build directories only.
#
# Controlling Environment Variables:
#  BUILD_PATH: Directory to build under (if existing, it will be deleted) [default: ${CMAKE_SOURCE_DIR}/_build/Int64.Debug]
...
BUILD_PATH=${BUILD_PATH:-${SRC_PATH}/_build/Int64.Debug}
...
ARGS="${ARGS} -DOPT_BLAS_INT64=On"  #Force 64-bit integer LAPACK support
