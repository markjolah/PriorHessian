...
macro(add_external_dependency)
    ...
    foreach(prop IN LIST ${_ExtProject_Print_Properties})
        get_target_property(_VAR ${_ExtProject_Target} ${prop})
        if(_VAR)
            message(STATUS "[add_external_dependency] [${_ExtProject_Target}] ${prop}: ${_VAR}")
        endif()
    endforeach()
endmacro()
